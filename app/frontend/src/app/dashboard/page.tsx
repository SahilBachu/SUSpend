      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 sm:py-10 lg:px-8 lg:py-12">
        <header className="mb-8">
          ...
          <p className="mt-2 text-sm text-zinc-500">
            Review company spending policies and audit employee expenses.
          </p>
        </header>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          {/* Left Column: Policy Section */}
            ...
            <div className="p-6 prose prose-zinc prose-sm max-w-none text-zinc-600 flex-grow">
              <div className="space-y-4">
                <p className="leading-relaxed text-base">
                  ...
                  discretion when incurring business expenses. All expenses must
                  be reasonable, necessary, and directly related to company
                  business.
                </p>
                <div className="bg-amber-50 rounded-xl p-5 border border-amber-100 shadow-sm mt-4">
                  ...
                  <ul className="space-y-2 text-amber-900/80 text-sm list-none p-0">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        <strong>Meals:</strong> Maximum $50 per day for
                        individual travel.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-amber-500 font-bold mt-0.5">•</span>
                      <span>
                        <strong>Travel:</strong> Economy class for flights under
                        6 hours.
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-amber-500 font-bold mt-0.5">•</span>
                      <span>
                        <strong>Receipts:</strong> Required for all expenses
                        over $25.
                      </span>
                    </li>
                  </ul>
                ...
                <div className="mt-6 p-4 bg-indigo-50/50 rounded-xl border border-indigo-100">
                  <p className="leading-relaxed text-sm text-indigo-900/80">
                    ...
                    When auditing an employee, verify that all submitted
                    expenses adhere to these guidelines. Flag any transactions
                    that exceed limits, lack proper documentation, or appear
